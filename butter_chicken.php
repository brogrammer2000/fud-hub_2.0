    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12" id="rec_desc">
                <p>
                    <h6>Similar to Chicken Tikka Masala, Butter Chicken is one of the most popular curries at any Indian restaurant around the world.<br>
                        Aromatic golden chicken pieces in an incredible creamy curry sauce, this Butter Chicken recipe is one of the best you will try!<br> I know you all love food with beautiful, bold flavours, and nothing beats sitting down to a good great curry to finish off a chaotic day. The aromas alone transport you to a completely different world.
                        <br>You will love how easy it is to make in the comfort of your own home.</h6>
                </p>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-6" id="ingredients">
                ...
                <p>
                    ...
                    <ul>
                        <h6 style="color:red"> For the sauce:</h6>
            ...
            <div class="col-sm-6" id="rec_vid">
                <iframe src="https://www.youtube.com/embed/VHfhCXkJh34" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
        </div>
            ...
            <div class="col-sm-12" id="instructions">
                ...
                <p>
                    <ul>
                        ...
                        <li>Heat oil in a large skillet or pot over medium-high heat. When sizzling, add chicken pieces in batches of two or three, making sure not to crowd the pan. Fry until browned for only 3 minutes on each side. Set aside and keep warm.</li>
                        <li> Heat butter or ghee in the same pan. Fry the onions until they start to sweat (about 6 minutes) while scraping up any browned bits stuck on the bottom of the pan.
                        ...
                        </li>Garnish with chopped cilantro and serve with fresh, hot basmati rice.</li>
                    </ul>
                </p>
        ...
        <div class="row">
            <div class="col-sm-6" id="notes_nutrition">
                ...
                <p>
                    <ul>
                        <li>To thin out the sauce, add a couple tablespoons of ghee or butter at the end of cooking, and gently simmer it through. Alternatively, add a small amount of water. </li>
                        <li>Calories: 120</li>
        ...
        <div class="row" id="comments">
            <div class="col-lg-5" id="comments_input">
                ...
                <form>
                    ...
                    <p>RATING</p>
                    <input id="input_box" class="info" type="number" max="5" min="0" name="website">
                    <br>
                    <br>
